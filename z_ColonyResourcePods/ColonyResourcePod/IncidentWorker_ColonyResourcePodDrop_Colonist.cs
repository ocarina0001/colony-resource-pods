...
{
    public class IncidentWorker_ColonyResourcePodDrop_Colonist : IncidentWorker
    {
		...
		protected override bool TryExecuteWorker(IncidentParms parms)
		{
			...
			SendStandardLetter("OKA_LetterLabelColonyResourcePod_Colonist".Translate(), "OKA_ColonyResourcePodDrop_Colonist".Translate(), LetterDefOf.PositiveEvent, parms, new TargetInfo(pos, map));
			return true;
		}
		...
		{
			SkyfallerMaker.SpawnSkyfaller(ThingDefOf.OKA_ColonyResourcePod_ColonistIncoming, ThingDefOf.OKA_ColonyResourcePod_Colonist, pos, map);
		}

		private bool TryFindColonyResourcePodDropCell(IntVec3 nearLoc, Map map, int maxDist, out IntVec3 pos)
		{
			return CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.OKA_ColonyResourcePod_ColonistIncoming, map, out pos, 10, nearLoc, maxDist);
		}
	}
}
